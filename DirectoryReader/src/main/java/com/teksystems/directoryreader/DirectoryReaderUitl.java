...
public class DirectoryReaderUitl {
	 ...
	 * @param tabs
	 */
	public void listAllFilesRecursively(File dir) {
	 ...
	 * @param dir
	 */
	private void iterateListOfFiles(List<String> sortedListOfFiles, File dir) {
	...
	private void printFileOnconsole(File file) {
		...
		if (file.isDirectory()) {
			System.out.println(
					"- Project: " + file.getName() + " - URL: " + file.getAbsolutePath().substring(lenghtOfDirectory));
		} else {
			System.out.println("- Document: " + file.getName() + " - Extension: ." + split[split.length - 1]
	...
	public static void main(String[] args) {
		...
		directoryReaderUitl.listAllFilesRecursively(rootDirectory);
	}
}
